package spring.joboffers.features;

import com.fasterxml.jackson.core.type.TypeReference;
import com.github.tomakehurst.wiremock.client.WireMock;
import spring.joboffers.BaseIntegrationTest;
import spring.joboffers.SampleJobOfferResponse;
...
import spring.joboffers.infrastructure.offer.scheduler.HttpOffersScheduler;
...
public class TypicalScenarioUserWantToSeeOffersIntegrationTest extends BaseIntegrationTest implements SampleJobOfferResponse {
    ...
    static {
        ...
        System.setProperty("offer.http.client.config.uri", WIRE_MOCK_HOST);
        System.setProperty("offer.http.client.config.port", String.valueOf(wireMockServer.getPort()));
    }
